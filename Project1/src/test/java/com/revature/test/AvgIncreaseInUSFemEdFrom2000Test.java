...
public class AvgIncreaseInUSFemEdFrom2000Test {
	...
	//because the combiner outputs an ArrayWritable, withOutput() wouldn't be able to properly
	//		check it. We'll need to get() the output from the combiner to AssertEquals() manually.
	private YearlyDifferenceReducer combiner;
	//mrunit mapreduce
	...
	public void setUp() {
		...
		combiner = new YearlyDifferenceReducer();
	...
	public void testMapper() {
		...
		//expected output
		double[] doub = {93.88283,94.77221,93.0587,95.3905,96.89634,97.06396,95.63982,96.82829,96.10534,96.43099,95.16566,95.25471,95.58667,96.37354,98.47282, -1, -1};
